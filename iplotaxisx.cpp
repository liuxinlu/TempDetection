...
void CiPlotAxisX::DoEditMenuItemClick()
{
	InvokeHelper(0x67, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

long CiPlotAxisX::GetTrackingIncrementStyle()
{
	long result;
...
void CiPlotAxisX::SetTrackingIncrementStyle(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL CiPlotAxisX::GetUserCanEdit()
{
	BOOL result;
...
void CiPlotAxisX::SetUserCanEdit(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void CiPlotAxisX::SetCanFocus(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
double CiPlotAxisX::GetTrackingSpanMinimum()
{
	double result;
	InvokeHelper(0x6b, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, NULL);
	return result;
}

void CiPlotAxisX::SetTrackingSpanMinimum(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
double CiPlotAxisX::GetTrackingMaxMargin()
{
	double result;
...
void CiPlotAxisX::SetTrackingMaxMargin(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
double CiPlotAxisX::GetTrackingMinMargin()
{
	double result;
...
void CiPlotAxisX::SetTrackingMinMargin(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
