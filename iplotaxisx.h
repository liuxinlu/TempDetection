#if !defined(AFX_IPLOTAXISX_H__8A458DF1_46B3_4818_830B_CDEAA1C4491E__INCLUDED_)
#define AFX_IPLOTAXISX_H__8A458DF1_46B3_4818_830B_CDEAA1C4491E__INCLUDED_
...
public:
	...
	long GetTrackingIncrementStyle();
	void SetTrackingIncrementStyle(long nNewValue);
	BOOL GetUserCanEdit();
	void SetUserCanEdit(BOOL bNewValue);
	BOOL GetCanFocus();
	void SetCanFocus(BOOL bNewValue);
	double GetTrackingSpanMinimum();
	void SetTrackingSpanMinimum(double newValue);
	double GetTrackingMaxMargin();
	void SetTrackingMaxMargin(double newValue);
	double GetTrackingMinMargin();
	void SetTrackingMinMargin(double newValue);
};

//{{AFX_INSERT_LOCATION}}
// Microsoft Visual C++ will insert additional declarations immediately before the previous line.

#endif // !defined(AFX_IPLOTAXISX_H__8A458DF1_46B3_4818_830B_CDEAA1C4491E__INCLUDED_)
