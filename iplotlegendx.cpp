...
void CiPlotLegendX::SetViewStartIndex(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CiPlotLegendX::DoEditMenuItemClick()
{
	InvokeHelper(0x3b, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

long CiPlotLegendX::GetLineColumnWidth()
{
	long result;
...
void CiPlotLegendX::SetLineColumnWidth(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CiPlotLegendX::GetLineColumnHeight()
{
	long result;
...
void CiPlotLegendX::SetLineColumnHeight(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL CiPlotLegendX::GetUserCanEdit()
{
	BOOL result;
...
void CiPlotLegendX::SetUserCanEdit(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL CiPlotLegendX::GetCanFocus()
{
	BOOL result;
...
void CiPlotLegendX::SetCanFocus(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
