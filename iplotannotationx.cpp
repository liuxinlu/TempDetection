...
long CiPlotAnnotationX::GetReferencePositionX()
{
	long result;
...
void CiPlotAnnotationX::SetReferencePositionX(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CiPlotAnnotationX::GetReferencePositionY()
{
	long result;
...
void CiPlotAnnotationX::SetReferencePositionY(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CiPlotAnnotationX::GetReferenceSizeX()
{
	long result;
...
void CiPlotAnnotationX::SetReferenceSizeX(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CiPlotAnnotationX::GetReferenceSizeY()
{
	long result;
...
void CiPlotAnnotationX::SetReferenceSizeY(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CiPlotAnnotationX::PolyPointAdd(double X, double Y)
{
	long result;
	static BYTE parms[] =
		VTS_R8 VTS_R8;
...
void CiPlotAnnotationX::PolyPointsClear()
{
	InvokeHelper(0x2b, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

long CiPlotAnnotationX::GetPolyPointsCount()
{
	long result;
...
double CiPlotAnnotationX::GetPolyPointX(long Index)
{
	double result;
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x2d, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, parms,
		Index);
	return result;
}

void CiPlotAnnotationX::SetPolyPointX(long Index, double newValue)
{
	static BYTE parms[] =
		VTS_I4 VTS_R8;
...
double CiPlotAnnotationX::GetPolyPointY(long Index)
{
	double result;
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x2e, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, parms,
		Index);
	return result;
}

void CiPlotAnnotationX::SetPolyPointY(long Index, double newValue)
{
	static BYTE parms[] =
		VTS_I4 VTS_R8;
...
BOOL CiPlotAnnotationX::GetUserCanEdit()
{
	BOOL result;
...
void CiPlotAnnotationX::SetUserCanEdit(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL CiPlotAnnotationX::GetCanFocus()
{
	BOOL result;
...
void CiPlotAnnotationX::SetCanFocus(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long CiPlotAnnotationX::GetClickRectLeft()
{
	long result;
...
long CiPlotAnnotationX::GetClickRectRight()
{
	long result;
...
long CiPlotAnnotationX::GetClickRectTop()
{
	long result;
...
long CiPlotAnnotationX::GetClickRectBottom()
{
	long result;
...
CPicture CiPlotAnnotationX::GetImage()
{
	LPDISPATCH pDispatch;
...
void CiPlotAnnotationX::SetImage(LPDISPATCH newValue)
{
	static BYTE parms[] =
		VTS_DISPATCH;
...
void CiPlotAnnotationX::ImageClear()
{
	InvokeHelper(0x36, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

void CiPlotAnnotationX::ImageLoadFromFile(LPCTSTR FileName)
{
	static BYTE parms[] =
		VTS_BSTR;
...
BOOL CiPlotAnnotationX::GetSelectModeOnlyInteraction()
{
	BOOL result;
...
void CiPlotAnnotationX::SetSelectModeOnlyInteraction(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long CiPlotAnnotationX::GetTextLineAlignment()
{
	long result;
...
void CiPlotAnnotationX::SetTextLineAlignment(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
