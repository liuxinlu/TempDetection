...
{
	switch (LastAlarmStatus[UserSelectReader-1][0][0])
	{
	case 0:
		m_CtlTChart01.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][0]);//设定温度值
		m_CtlTChart01.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));//设定温度字体颜色
		m_CtlPowerChart01.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[UserSelectReader-1][0][0]);
		m_CtlPowerChart01.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart01.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][0]);//设定温度值
	...
	switch (LastAlarmStatus[UserSelectReader-1][0][1])
	{
	case 0:
		m_CtlTChart02.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][1]);//设定温度值
		m_CtlTChart02.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));//设定温度字体颜色
		m_CtlPowerChart02.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[UserSelectReader-1][0][1]);
		m_CtlPowerChart02.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart02.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][1]);//设定温度值
	...
	switch (LastAlarmStatus[UserSelectReader-1][0][2])
	{
	case 0:
		m_CtlTChart03.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][2]);//设定温度值
		m_CtlTChart03.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));//设定温度字体颜色
		m_CtlPowerChart03.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[UserSelectReader-1][0][2]);
		m_CtlPowerChart03.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart03.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][2]);//设定温度值
	...
	switch (LastAlarmStatus[UserSelectReader-1][0][3])
	{
	case 0:
		m_CtlTChart04.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][3]);//设定温度值
		m_CtlTChart04.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));//设定温度字体颜色
		m_CtlPowerChart04.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[UserSelectReader-1][0][3]);
		m_CtlPowerChart04.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart04.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][3]);//设定温度值
	...
	switch (LastAlarmStatus[UserSelectReader-1][0][4])
	{
	case 0:
		m_CtlTChart05.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][4]);//设定温度值
		m_CtlTChart05.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));//设定温度字体颜色
		m_CtlPowerChart05.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[UserSelectReader-1][0][4]);
		m_CtlPowerChart05.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart05.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][4]);//设定温度值
	...
	switch (LastAlarmStatus[UserSelectReader-1][0][5])
	{
	case 0:
		m_CtlTChart06.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][5]);//设定温度值
		m_CtlTChart06.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));//设定温度字体颜色
		m_CtlPowerChart06.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[UserSelectReader-1][0][5]);
		m_CtlPowerChart06.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart06.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][5]);//设定温度值
	...
	switch (LastAlarmStatus[UserSelectReader-1][0][6])
	{
	case 0:
		m_CtlTChart07.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][6]);//设定温度值
		m_CtlTChart07.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));//设定温度字体颜色
		m_CtlPowerChart07.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[UserSelectReader-1][0][6]);
		m_CtlPowerChart07.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart07.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][6]);//设定温度值
	...
	switch (LastAlarmStatus[UserSelectReader-1][0][7])
	{
	case 0:
		m_CtlTChart08.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][7]);//设定温度值
		m_CtlTChart08.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));//设定温度字体颜色
		m_CtlPowerChart08.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[UserSelectReader-1][0][7]);
		m_CtlPowerChart08.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart08.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][7]);//设定温度值
	...
	switch (LastAlarmStatus[UserSelectReader-1][0][8])
	{
	case 0:
		m_CtlTChart09.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][8]);//设定温度值
		m_CtlTChart09.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));//设定温度字体颜色
		m_CtlPowerChart09.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[UserSelectReader-1][0][8]);
		m_CtlPowerChart09.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart09.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][8]);//设定温度值
	...
	switch (LastAlarmStatus[UserSelectReader-1][0][9])
	{
	case 0:
		m_CtlTChart10.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][9]);//设定温度值
		m_CtlTChart10.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));//设定温度字体颜色
		m_CtlPowerChart10.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[UserSelectReader-1][0][9]);
		m_CtlPowerChart10.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart10.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][9]);//设定温度值
	...
	switch (LastAlarmStatus[UserSelectReader-1][0][10])
	{
	case 0:
		m_CtlTChart11.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][10]);//设定温度值
		m_CtlTChart11.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));//设定温度字体颜色
		m_CtlPowerChart11.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[UserSelectReader-1][0][10]);
		m_CtlPowerChart11.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart11.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][10]);//设定温度值
	...
	switch (LastAlarmStatus[UserSelectReader-1][0][11])
	{
	case 0:
		m_CtlTChart12.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][11]);//设定温度值
		m_CtlTChart12.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));//设定温度字体颜色
		m_CtlPowerChart12.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[UserSelectReader-1][0][11]);
		m_CtlPowerChart12.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart12.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[UserSelectReader-1][0][11]);//设定温度值
