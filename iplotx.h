#if !defined(AFX_IPLOTX_H__0EF27213_5600_4D6A_8CC1_4263CF6DEE24__INCLUDED_)
#define AFX_IPLOTX_H__0EF27213_5600_4D6A_8CC1_4263CF6DEE24__INCLUDED_
...
public:
	...
	long GetAnnotationDefaultReference();
	void SetAnnotationDefaultReference(long nNewValue);
	long GetAnnotationDefaultReferencePositionX();
	void SetAnnotationDefaultReferencePositionX(long nNewValue);
	long GetAnnotationDefaultReferencePositionY();
	void SetAnnotationDefaultReferencePositionY(long nNewValue);
	long GetAnnotationDefaultReferenceSizeX();
	void SetAnnotationDefaultReferenceSizeX(long nNewValue);
	long GetAnnotationDefaultReferenceSizeY();
	void SetAnnotationDefaultReferenceSizeY(long nNewValue);
	void RefreshLayoutManager();
	double GetPrintXStart();
	void SetPrintXStart(double newValue);
	double GetPrintXStop();
	void SetPrintXStop(double newValue);
	double GetPrinterPaperWidthInches();
	double GetPrinterPaperHeightInches();
	double GetPrinterPaperWidthCentimeters();
	double GetPrinterPaperHeightCentimeters();
	long GetPrinterPaperWidthPixels();
	long GetPrinterPaperHeightPixels();
	void PreviewChart();
	void PrintSizeToFillPage();
	void PrintAdjustXSpanToMinutesPerMillimeter(double MinutesPerMillimeter);
...
#endif // !defined(AFX_IPLOTX_H__0EF27213_5600_4D6A_8CC1_4263CF6DEE24__INCLUDED_)
