#if !defined(AFX_IPLOTCHANNELX_H__56B66B46_E161_4458_80CA_6E588F4EAAEA__INCLUDED_)
#define AFX_IPLOTCHANNELX_H__56B66B46_E161_4458_80CA_6E588F4EAAEA__INCLUDED_
...
public:
	...
	BOOL GetUserCanMoveDataPoints();
	void SetUserCanMoveDataPoints(BOOL bNewValue);
	long GetUserCanMoveDataPointsStyle();
	void SetUserCanMoveDataPointsStyle(long nNewValue);
	...
	double GetOPCScalar();
	void SetOPCScalar(double newValue);
	double GetOPCOffset();
	void SetOPCOffset(double newValue);
	BOOL GetShowDataPointHints();
	void SetShowDataPointHints(BOOL bNewValue);
	BOOL GetFillEnabled();
	...
	long CalcIndex(double TargetValue);
	BOOL GetAllowOutOfOrderXValues();
	void SetAllowOutOfOrderXValues(BOOL bNewValue);
	BOOL GetDrawOutOfOrderXValues();
	void SetDrawOutOfOrderXValues(BOOL bNewValue);
	BOOL GetResetStartTimeOnFirstDataPoint();
	void SetResetStartTimeOnFirstDataPoint(BOOL bNewValue);
	CString GetOPCItem2Name();
	void SetOPCItem2Name(LPCTSTR lpszNewValue);
	double GetOPCScalar2();
	void SetOPCScalar2(double newValue);
	double GetOPCOffset2();
	void SetOPCOffset2(double newValue);
};

//{{AFX_INSERT_LOCATION}}
// Microsoft Visual C++ will insert additional declarations immediately before the previous line.

#endif // !defined(AFX_IPLOTCHANNELX_H__56B66B46_E161_4458_80CA_6E588F4EAAEA__INCLUDED_)
