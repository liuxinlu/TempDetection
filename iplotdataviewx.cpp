...
void CiPlotDataViewX::DoEditMenuItemClick()
{
	InvokeHelper(0x33, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

BOOL CiPlotDataViewX::GetUserCanEdit()
{
	BOOL result;
...
void CiPlotDataViewX::SetUserCanEdit(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL CiPlotDataViewX::GetCanFocus()
{
	BOOL result;
...
void CiPlotDataViewX::SetCanFocus(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
