...
BOOL CiPlotTableX::GetHorizontal()
{
	BOOL result;
...
void CiPlotTableX::SetHorizontal(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void CiPlotTableX::DoEditMenuItemClick()
{
	InvokeHelper(0x25, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

long CiPlotTableX::GetRowDisplayStartIndex()
{
	long result;
...
void CiPlotTableX::SetRowDisplayStartIndex(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL CiPlotTableX::HitTest(long X, long Y)
{
	BOOL result;
	static BYTE parms[] =
		VTS_I4 VTS_I4;
...
BOOL CiPlotTableX::GetUserCanEdit()
{
	BOOL result;
...
void CiPlotTableX::SetUserCanEdit(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void CiPlotTableX::SetCanFocus(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
