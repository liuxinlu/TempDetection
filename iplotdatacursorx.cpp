...
void CiPlotDataCursorX::DoEditMenuItemClick()
{
	InvokeHelper(0x26, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

BOOL CiPlotDataCursorX::GetSnapToDataPoint()
{
	BOOL result;
...
void CiPlotDataCursorX::SetSnapToDataPoint(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long CiPlotDataCursorX::GetInterpolatedYValue(LPCTSTR ChannelName, double XValue, double* YValue)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_R8 VTS_PR8;
	InvokeHelper(0x28, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		ChannelName, XValue, YValue);
	return result;
}

BOOL CiPlotDataCursorX::GetUserCanEdit()
{
	BOOL result;
...
void CiPlotDataCursorX::SetUserCanEdit(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL CiPlotDataCursorX::GetCanFocus()
{
	BOOL result;
...
void CiPlotDataCursorX::SetCanFocus(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL CiPlotDataCursorX::GetUseCachedInterpolatedData()
{
	BOOL result;
...
void CiPlotDataCursorX::SetUseCachedInterpolatedData(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
